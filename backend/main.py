...
QUESTIONS = [
    "Who would you least want your sibling to date?",
    "Most likely to marry someone twice their age?",
    "Who dies first in an apocalypse?",
    "Most likely to be a 3-time divorcee?",
    "Worst digital footprint?",
    "Worst RBF?",
    "Mr/Mrs “I would’ve gone pro…”",
    "Most likely to get cancelled?",
    "Who’s not over their ex?",
    "Most likely to end up in jail tonight?",
    "Most likely to cheat?",
    "Most likely to crash a car?",
    "Most likely to get scammed?",
    "Best parent (present or future)?",
    "Worst parent (present or future)?",
    "Most mysterious source of income?",
    "Most likely to cry watching a kids movie?",
    "Most likely to wake up with a Mike Tyson tattoo?",
    "Most likely to end up on a reality TV show?",
    "Most likely to become a cult leader?",
    "Most likely to peak in their 20s?",
    "Most likely to marry someone they met online?",
    "Most likely to still be sleeping on an air mattress at 35?",
    "Most likely to date their situationship's best friend?",
    "Most likely to get kicked out of a country?",
    "Who has the most questionable Spotify wrapped?",
    "Who's most likely to get banned from a bar?",
    "Worst advice giver?",
    "Most emotionally unavailable?",
    "Worst at keeping a secret?",
    "Most likely to drunk text their boss?",
    "Most likely to get catfished?",
    "Most likely to be on a first name basis with their Uber driver within 2 minutes?",
    "Most likely to cry at a dog food commercial?",
    "Most likely to name their Roomba?",
    "Most likely to marry a drug lord?",
    "Next person to have a kid?",
    "Most brainrotted?",
    "Highest screen time?",
    "Most likely to go a week without a shower?",
    "Who would you trust the least with your phone unlocked?",
    "Most likely to ruin a group trip?",
    "Most likely to get kicked out of a family reunion?",
    "Most likely to cry over a situationship?",
    "Most likely to delete Instagram and come back in 2 days?",
    "Most likely to post “Dhmu” on their snap story?",
    "Most likely to get banned from a zoo?",
    "Worst driver?",
    "Worst search history?",
    "Most likely to never get married?",
    "Worst taste in dating?",
    "Most likely to have a shotgun wedding?",
    "Most likely to adopt an orphaned squirrel and raise it?",
    "Most likely to pay for a looksmaxing course?",
    "Most likely to sell a dropshipping course with zero experience?",
    "Most likely to be a Navy Seal?",
    "Most likely to be hunted by the Navy Seals?",
    "Most likely to’ve lost money on NFT’s?",
    "Most like to’ve been homeschooled?",
    "Most likely to be on a government watchlist?",
    "Most likely to unironically use the word \"manifesting\"?",
    "Most likely to have googled \"am I a narcissist\"?",
    "Most likely to have practiced an acceptance speech in the mirror?",
    "Most likely to have been mistaken for someone famous?",
    "Most likely to baby-talk their partner?",
    "Most likely to have a tattoo with a typo?",
    "Most likely to have a complicated history with a trampoline park?",
    "Most likely to have a nickname in a city they've only visited once?",
    "Most likely to AI generate a breakup text?",
    "Most likely to AI generate a love letter?"
]
